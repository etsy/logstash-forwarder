...
go-check:
	...
	@go version | grep -Eq 'go version go1.[12]' || (echo "Go version 1.1.x or 1.2.x required, you have a version of go that is too old See http://golang.org/doc/install for upgrading."; false)
